...
class CorbalarSayfasi(QWidget):
    ...
    def ust_kisim(self):
        ...
        dugmeler = [
            ...
            ("Çorbalar", lambda: self.parent.stacked_widget.setCurrentWidget(self)),  # Mevcut sayfa
    ...
    def tarifleri_yukle(self):
        ...
        corba_tarifleri = self.veritabani.tur_gore_tarifleri_getir("Çorba")
        if not corba_tarifleri:
            bos_etiket = QLabel("Henüz hiç çorba tarifi eklenmedi.")
        ...
        satir = 0
        sutun = 0
        for tarif_id, tarif_adi in corba_tarifleri:
