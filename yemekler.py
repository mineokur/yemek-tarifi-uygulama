...
class YemeklerSayfasi(QWidget):
    ...
    def ust_kisim(self):
        ...
        dugmeler = [
            ...
            ("Yemekler", lambda: self.parent.stacked_widget.setCurrentWidget(self)),  # Mevcut sayfa
    ...
    def tarifleri_yukle(self):
        ...
        yemek_tarifleri = self.veritabani.tur_gore_tarifleri_getir("Yemek")
        if not yemek_tarifleri:
            bos_etiket = QLabel("Henüz hiç yemek tarifi eklenmedi.")
        ...
        satir = 0
        sutun = 0
        for tarif_id, tarif_adi in yemek_tarifleri:
