...
class IceceklerSayfasi(QWidget):
    ...
    def ust_kisim(self):
        ...
        dugmeler = [
            ...
            ("İçecekler", lambda: self.parent.stacked_widget.setCurrentWidget(self)),  # Mevcut sayfa
    ...
    def tarifleri_yukle(self):
        ...
        icecek_tarifleri = self.veritabani.tur_gore_tarifleri_getir("İçecek")
        if not icecek_tarifleri:
            bos_etiket = QLabel("Henüz hiç içecek tarifi eklenmedi.")
        ...
        satir = 0
        sutun = 0
        for tarif_id, tarif_adi in icecek_tarifleri:
